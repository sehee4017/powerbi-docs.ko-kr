...
## <a name="two-ways-to-get-started"></a>시작하는 두 가지 방법
Excel에서 Power BI 데이터 세트를 탐색하는 방법에는 두 가지가 있습니다. Power BI에서 시작하는 경우 이 문서에 설명된 단계를 따릅니다.  또한 이제 특정 Office SKU를 사용하는 사용자가 Excel 통합 문서 내의 데이터 가져오기 환경에서 직접 데이터 세트에 액세스할 수 있습니다.  액세스 권한이 있는 데이터 세트를 검색하여 데이터 세트의 인증 및 승격 여부, 데이터 보호 레이블의 적용 여부를 확인할 수 있습니다.  이 환경에 대한 자세한 내용은 Excel 설명서의 [Power BI 데이터 세트에서 피벗 테이블 만들기](https://support.office.com/article/31444a04-9c38-4dd7-9a45-22848c666884)를 참조하세요.
...
* 게스트 사용자는 다른 테넌트에서 전송되는 데이터 세트에 대해 **Excel에서 분석**을 사용할 수 없습니다. 
...
## <a name="get-started-with-analyze-in-excel-in-power-bi"></a>Power BI의 Excel에서 분석 시작
