...
* 온-프레미스 배포의 기본 포함 URL 콘텐츠를 통해 Power BI Report Server 콘텐츠를 포함합니다. [Power BI 보고서 서버 URL 만들기](../report-server/quickstart-embed.md#create-the-power-bi-report-url)의 단계들을 수행하여 URL을 가져옵니다. 일반 인증 규칙이 적용되므로 콘텐츠를 보려면 온-프레미스 서버에 대한 VPN 연결이 필요합니다. 
...
![스크린샷은 [앱을 자동으로 설치]가 선택된 Power BI 게시 앱 옵션을 보여줍니다.](media/service-create-distribute-apps//power-bi-apps-access.png)
...
![스크린샷은 게시된 앱이 포함된 Power BI 앱을 보여줍니다.](media/service-create-distribute-apps/power-bi-apps-left-nav.png)
...
* [Power BI 관리 포털](../admin/service-admin-portal.md)
