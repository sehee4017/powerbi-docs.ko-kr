...
사용량 메트릭 보고서는 Power BI 또는 Office 365 관리자가 켜거나 끌 수 있는 기능입니다. 관리자는 사용자가 사용 메트릭에 대한 액세스를 갖는지 세부적으로 제어합니다. 기본적으로 조직의 모든 사용자에 대해 적용됩니다. 설정에 대한 자세한 내용은 관리 포털 문서에서 [사용 메트릭 제어](../admin/service-admin-portal.md#control-usage-metrics)를 참조하세요.
