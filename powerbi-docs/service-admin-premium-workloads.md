...
|                     | EM2                      | EM3                       | P1                      | P2                       | P3                       |
|---------------------|--------------------------|--------------------------|-------------------------|--------------------------|--------------------------|
| AI | 기본값 40%, 최소값 40% | 기본값 20%, 최소값 20% | 기본값 20%, 최솟값 8% | 기본값 20%, 최솟값 4% | 기본값 20%, 최솟값 2% |
...
|                  | A1                       | A2                       | A3                      | A4                       | A5                      | A6                        |
|-------------------|--------------------------|--------------------------|-------------------------|--------------------------|-------------------------|---------------------------|
| AI | 해당 없음  | 기본값 40%, 최소값 40%  | 기본값 20%, 최소값 20% | 기본값 20%, 최솟값 8% | 기본값 20%, 최솟값 4% | 기본값 20%, 최솟값 2% |
