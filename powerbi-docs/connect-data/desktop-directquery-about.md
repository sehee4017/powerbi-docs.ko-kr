...
> [!NOTE]
> 최대 DirectQuery 연결 수 설정은 [향상된 메타데이터](desktop-enhanced-dataset-metadata.md)를 사용하도록 설정한 경우 모든 DirectQuery 원본에 적용됩니다. 이는 2020년 10월부터 Power BI Desktop에서 생성되는 모든 모델에 대한 기본 설정입니다. 
