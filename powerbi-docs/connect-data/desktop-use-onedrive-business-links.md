...
1. 브라우저를 사용하여 비즈니스용 OneDrive 위치로 이동합니다. 사용할 파일을 마우스 오른쪽 단추로 클릭하고 **Excel에서 열기**를 선택합니다.
   ...
   ![Excel에서 열기 선택을 보여 주는 브라우저에 있는 OneDrive의 스크린샷.](media/desktop-use-onedrive-business-links/odb-links_02.png)

2. Excel에서 다음 그림에 표시된 것처럼 **파일** > **정보**을 선택한 다음 **경로 복사** 단추를 선택합니다.
   
   ![경로 복사 단추 선택을 보여 주는 정보 메뉴의 스크린샷.](media/desktop-use-onedrive-business-links/onedrive-copy-path.png)
...
1. Power BI Desktop에서 **데이터 가져오기** > **웹**을 선택합니다.
   ...
   ![웹 선택 항목을 보여 주는 Power BI Desktop에 있는 데이터 가져오기 리본의 스크린샷.](media/desktop-use-onedrive-business-links/power-bi-web-link-onedrive.png)
2. **Basic** 옵션을 선택한 상태에서 링크를 **웹에서** 대화 상자에 붙여넣습니다.
3. Power BI Desktop에서 파일을 올바르게 탐색할 수 있도록 링크 끝에 있는 *?web=1* 문자열을 제거한 다음 **확인**을 선택합니다.
   
    ![URL 필드에서 문자열을 제거하는 방법을 보여 주는 웹에서 대화 상자의 스크린샷.](media/desktop-use-onedrive-business-links/power-bi-web-link-confirmation.png) 
4. Power BI Desktop에서 자격 증명을 묻는 메시지가 표시되면 **Windows**(온-프레미스 SharePoint 사이트인 경우) 또는 **조직 계정**(Microsoft 365 또는 비즈니스용 OneDrive 사이트인 경우) 중 하나를 선택합니다.
   ...
   ![Windows 또는 조직 계정 선택을 보여 주는 Power BI Desktop 자격 증명 프롬프트의 스크린샷.](media/desktop-use-onedrive-business-links/odb-links_06.png)
