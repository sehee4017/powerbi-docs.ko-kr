...
ms.locfileid: "81436325"
---
# <a name="power-bi-licensing-in-your-organization"></a>조직의 Power BI 라이선스 부여

Power BI 서비스에서 사용자가 수행할 수 있는 작업은 사용자가 보유한 사용자별 라이선스 유형 및 작업하는 콘텐츠가 Power BI Premium 용량에 할당된 작업 영역에 있는지 여부에 따라 다릅니다. Power BI 서비스의 모든 사용자에게 라이선스가 있어야 합니다.
...
이 문서에서는 관리자 관점에서 구매 서비스 및 사용자별 라이선싱에 대해 집중적으로 살펴봅니다. 사용자가 자신의 라이선스를 얻을 수 있는 방법에 대한 자세한 내용은 [Power BI에 개별 등록](service-self-service-signup-for-power-bi.md)을 참조하세요.
...
전역 관리자 또는 청구 관리자는 조직의 사용자에 대한 Power BI 서비스를 등록하고 라이선스를 구입할 수 있습니다. 구매할 준비가 되지 않은 경우 Power BI Pro 평가판을 선택합니다. 한 달에 사용할 25개의 라이선스를 받게 됩니다. 등록하는 방법에 대한 단계별 지침은 [조직의 Power BI 구독 가져오기](admin/service-admin-org-subscription.md)를 참조하세요.

## <a name="about-self-service-sign-up"></a>셀프 서비스 등록 정보

개별 사용자는 회사 또는 학교 계정으로 등록하여 자신의 Power BI 라이선스를 받을 수 있습니다. 사용자는 무료 라이선스를 사용하여 내 작업 영역을 사용하는 개인 데이터 분석 및 시각화에 대한 Power BI를 탐색할 수 있지만 다른 사용자와 협업을 시작할 수 없습니다. 콘텐츠를 공유하려면 Power BI Pro 라이선스가 필요합니다. 조직에서 상용 클라우드를 사용하는 경우 사용자는 라이선스 유형을 Pro로 업그레이드하거나 Pro에 직접 등록할 수 있습니다. 정부 또는 소버린 클라우드 인스턴스에 배포된 교육 조직이나 조직에서는 Pro를 직접 구매하거나 Pro로 업그레이드할 수 없습니다.

조직의 사용자가 셀프 서비스 등록을 사용하지 않도록 하려면 [셀프 서비스 등록 사용 또는 사용 안 함](admin/service-admin-disable-self-service.md)을 참조하여 사용하지 않도록 설정하는 방법을 알아보세요.

조직에서 이미 라이선스가 있는 사용자를 확인하려면 [사용자 라이선스 보기 및 관리](admin/service-admin-manage-licenses.md)를 참조하여 방법을 알아보세요.
...
구독의 한 가지 유형인 [Power BI Premium](service-admin-premium-purchase.md)을 사용하면 무료 라이선스를 가진 사용자는 프리미엄 용량에 할당된 작업 영역의 콘텐츠에 대해 작업을 수행할 수 있습니다. 무료 라이선스를 가진 사용자는 프리미엄 용량 외에 Power BI 서비스를 사용하여 데이터에 연결하고 개인 작업 영역에서 보고서 및 대시보드를 만들기만 할 수 있습니다. 다른 사용자와 콘텐츠를 공유하거나 앱 작업 영역에 콘텐츠를 게시할 수 없습니다.

표준 Power BI 구독은 공유 용량을 사용합니다. 콘텐츠가 공유 용량에 저장되는 경우 Power BI Pro 라이선스가 할당된 사용자는 다른 Power BI Pro 사용자와만 공동 작업을 수행할 수 있습니다. 다른 사용자가 공유한 콘텐츠를 사용하고, 앱 작업 영역에 콘텐츠를 게시하고, 대시보드를 공유하며, 대시보드 및 보고서를 구독할 수 있습니다.  작업 영역이 프리미엄 용량에 있는 경우 Pro 사용자는 Power BI Pro 라이선스가 없는 사용자에게 콘텐츠를 배포할 수 있습니다.

아래 표에는 각 라이선스 유형의 기본 기능이 요약되어 있습니다. 라이선스 유형별 기능 가용성에 대한 자세한 내용은 [라이선스 유형별 기능](service-features-license-type.md)을 참조하세요.

| 라이선스 유형 | 작업 영역이 공유 용량에 있는 경우의 기능 | 작업 영역이 프리미엄 용량에 있는 경우의 추가 기능 |
| --------- | ----------- | ----------- |
| Power BI(무료) | 내 작업 영역의 콘텐츠에 액세스 | 공유한 콘텐츠 사용 |
| Power BI Pro | 앱 작업 영역에 콘텐츠를 게시하고, 대시보드를 공유하며, 대시보드 및 보고서를 구독하고, Pro 라이선스가 있는 사용자와 공유합니다. | 무료 라이선스를 보유한 사용자에게 콘텐츠 배포 |

## <a name="subscription-types"></a>구독 유형

Microsoft의 모든 사용자 기반 상용 라이선스 구독은 Azure Active Directory ID를 기반으로 합니다. 즉, 상용 라이선스를 지원하는 Azure Active Directory ID로 로그인해야 합니다. ID 서비스에 대해 Azure Active Directory를 사용하는 모든 Microsoft 구독에 Power BI 구독을 추가할 수 있습니다. Office 365 E5와 같은 일부 구독은 Power BI Pro 라이선스를 포함하므로 Power BI의 별도 등록이 필요하지 않습니다.

조직에 대한 Power BI 구독에는 두 가지 종류, Power BI Pro를 사용하는 셀프 서비스 및 Power BI Premium을 사용하는 고급 분석이 있습니다.

관리자는 표준 셀프 서비스 Power BI Pro 구독을 사용하여 사용자별 라이선스를 할당합니다. 협업, 게시, 공유 및 임시 분석을 가능하게 하는 Power BI Pro 라이선스에 대한 사용자별 월별 요금이 있습니다. 콘텐츠는 Microsoft에서 완전히 관리되는 공유 스토리지 용량에 저장됩니다.
...
- [Microsoft 365 비즈니스 구독 및 청구 설명서](https://docs.microsoft.com/microsoft-365/commerce/?view=o365-worldwide)
