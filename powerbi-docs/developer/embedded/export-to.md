---
title: Power BI 임베디드 분석 보고서 API 내보내기
...
>[!NOTE]
>`exporToFile` API를 사용하여 Power BI 보고서를 파일로 내보내는 것은 [PPU(사용자 단위 Premium)](../../admin/service-premium-per-user-faq.md)에 대해 지원되지 않습니다. 
