...
SaaS 애플리케이션 스토리지가 모든 테넌트에 다중 테넌트 데이터베이스를 사용하는 경우에는 작업 영역별로 테넌트를 쉽게 분리할 수 있습니다. 관련 테넌트의 데이터만 검색하는 매개 변수화된 데이터베이스 쿼리를 사용하여 Power BI 데이터 세트의 데이터베이스 연결을 구성할 수 있습니다. [Power BI Desktop](../../transform-model/desktop-query-overview.md)을 사용하거나 쿼리에서 [API](https://docs.microsoft.com/rest/api/power-bi/datasets/updatedatasourcesingroup)를 [매개 변수](https://docs.microsoft.com/rest/api/power-bi/datasets/updateparametersingroup)와 함께 사용하여 연결을 업데이트할 수 있습니다.
