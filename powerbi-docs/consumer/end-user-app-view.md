...
4. 원하는 앱을 찾은 경우 **지금 가져오기** 를 선택하여 설치합니다.
   ...
   ![지금 가져오기 단추를 보여 주는 스크린샷](./media/end-user-app-view/power-bi-get-now.png)
...
![앱 콘텐츠 목록의 스크린샷](./media/end-user-app-view/power-bi-apps-card.png)

앱을 가리키고 선택하여 엽니다. 앱에 따라 다음과 같은 프롬프트가 표시될 수 있습니다.

![세 가지 선택 항목인 탐색, 연결 및 사용자 지정의 스크린샷](./media/end-user-app-view/power-bi-customize.png)
...
![이름, 타임스탬프, 소유자 및 작업을 보여 주는 앱 가리키기 상태의 스크린샷. ](./media/end-user-app-view/power-bi-app-hover.png)

앱이 열립니다. 모든 앱은 다양한 레이아웃, 시각적 개체, 색, 옵션에 따라 다르게 보입니다. 그러나 모든 앱에는 몇 가지 일반적인 기능이 있습니다.

![숫자로 식별된 다양한 영역을 사용하는 영업 및 마케팅 앱의 스크린샷 ](./media/end-user-app-view/power-bi-app-number.png)
...
* AppSource에서 템플릿 앱을 가져온 경우 다음에 앱을 열 때 알림 배너가 표시됩니다. 알림을 통해 새 버전을 사용할 수 있다는 것을 알 수 있습니다. 
    ...
    2. 업데이트된 앱을 설치하라는 메시지가 표시되면 **설치** 를 선택합니다. 
        ...
        ![업데이트 설치](./media/end-user-app-view/power-bi-installs.png) 
