...
![앱 콘텐츠 목록의 스크린샷](./media/end-user-app-view/power-bi-apps-list.png)
...
![이름, 타임스탬프, 소유자 및 작업을 보여 주는 앱 가리키기 상태의 스크린샷. ](./media/end-user-app-view/power-bi-apps-hover.png)

앱이 열립니다. 모든 앱은 다양한 레이아웃, 시각적 개체, 색, 옵션에 따라 다르게 보입니다. 그러나 모든 앱에는 몇 가지 일반적인 기능이 있습니다.

![숫자로 식별된 다양한 영역을 사용하는 영업 및 마케팅 앱의 스크린샷 ](./media/end-user-app-view/power-bi-app-numbered.png)
...
- 앱을 사용하려면 Pro 라이선스가 있거나 앱을 프리미엄 공유 용량에 저장해야 합니다. [라이선스에 대해 알아봅니다](end-user-license.md).
