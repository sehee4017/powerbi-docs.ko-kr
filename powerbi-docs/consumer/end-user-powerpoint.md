...
* **PowerPoint로 내보내기** 메뉴 항목을 Power BI 서비스에서 사용할 수 없다면 Power BI 관리자 또는 보고서 소유자가 이 기능을 사용하지 않도록 설정했을 가능성이 큽니다. 자세한 내용은 관리자 또는 소유자에게 문의하세요.
