...
![다양한 원본에서 콘텐츠를 가져오고 보고서를 출력하는 Power BI를 보여 주는 스크린샷.](./media/end-user-reading-view/power-bi-concept.png)
...
![휴대폰과 컴퓨터 브라우저에서 동일한 보고서를 보여 주는 아트.](./media/end-user-reading-view/power-bi-report-phone.png)
...
![휴대폰과 컴퓨터 브라우저 화면에 표시되는 동일한 대시보드를 보여 주는 아트.](./media/end-user-reading-view/power-bi-dashboard-phone.png)
...
![구독 아이콘 선택](./media/end-user-reading-view/power-bi-subscribe-and-email.png)
...
![질문 및 답변](./media/end-user-reading-view/power-bi-q-and-a-funnel.png)
...
![보고서 보기 메뉴](media/end-user-reading-view/power-bi-view-icon.png)
...
![포커스 모드 아이콘을 가리키는 화살표가 있는 스크린샷.](media/end-user-reading-view/power-bi-fullscreen.png)
...
![전체 화면 모드에서 동일한 시각적 개체를 보여 주는 스크린샷.](media/end-user-reading-view/power-bi-full.png)
