...
새로 고침 예약에 대한 자세한 내용은 Power BI 데이터 세트의 새로 고침 동작에 대해 설명하는 [예약된 새로 고침 구성](../connect-data/refresh-scheduled-refresh.md) 문서를 참조하세요. 새로 고침 설정 측면에서는 데이터 흐름이 Power BI 데이터 세트와 동일하게 작동합니다. 
