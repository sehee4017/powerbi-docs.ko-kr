...
2. 병합, 조인, 변환 및 [기타](/power-query/power-query-folding#transformations-that-can-achieve-folding)와 같이 접는 작업을 수행해야 합니다.
