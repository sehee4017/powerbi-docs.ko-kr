...
1. ADLS 스토리지 계정의 소유자여야 합니다. 이는 구독 수준에서 상속되는 것이 아니라 리소스 수준에서 할당되어야 합니다.
...
Azure Portal에서 Azure Data Lake Storage Gen2 계정을 설정했으면, **Power BI 관리 포털**에서 계정을 Power BI에 연결합니다. 또한 Power BI 관리 포털의 **데이터 흐름 스토리지** 설정 섹션에서 Power BI 데이터 흐름 스토리지를 관리합니다. 시작 및 기본 사용에 대한 자세한 내용은 [관리 포털에 도달하는 방법](../admin/service-admin-portal.md)을 참조하세요.
