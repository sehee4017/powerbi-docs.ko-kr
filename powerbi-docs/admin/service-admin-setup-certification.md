...
1. 토글을 **사용**으로 설정합니다.
1. 데이터 세트 인증의 경우 조직에 게시된 인증 정책이 있으면 해당 URL을 여기에 입력할 수 있습니다. 그러면 **데이터 흐름 보증 설정 대화 상자**의 인증 섹션에 있는 [자세한 정보](../connect-data/service-datasets-promote.md#request-dataset-certification) 링크가 됩니다. 
