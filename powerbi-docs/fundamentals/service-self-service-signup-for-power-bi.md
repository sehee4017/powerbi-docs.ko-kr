...
![Power BI Desktop, 서비스 및 모바일 관련 통합 관계의 스크린샷을 보여 주는 다이어그램.](media/service-self-service-signup-for-power-bi/power-bi-tools.png)
...
1. 다음 대화 상자 중 하나를 받을 수 있습니다. 
    - 메시지가 표시되면 조직 계정을 사용하여 로그인합니다.
        ...
        ![새 메일 주소 입력을 요구하는 프롬프트를 보여 주는 Power BI 서비스의 스크린샷.](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-sign-in.png)
...
1. 필요에 따라 조인할 일부 동료를 초대합니다.
   ...
   ![“더 많은 사용자 초대” 화면을 보여 주는 Power BI 서비스의 스크린샷.](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-friends.png)    
...
**개인 메일 주소** 개인 메일 주소(예: nancy@gmail.com)를 사용하여 가입하려고 하면 다음 중 하나와 비슷한 메시지가 표시됩니다. 
...
**해결 방법** Power BI는 소비자 메일 서비스나 전자 통신 공급자가 제공하는 메일 주소를 지원하지 않습니다. 등록을 완료하려면 회사 또는 학교에서 할당한 메일 주소를 사용하여 다시 시도하세요. 
...
**메일 주소가 Microsoft 365 ID가 아닙니다.** 가입하려고 하면 다음과 같은 메시지가 표시됩니다.

*contoso.com에서 사용자를 찾을 수 없습니다.  회사 또는 학교에서 다른 ID를 사용하나요?  해당 ID로 로그인하고, 그래도 작동하지 않으면 IT 부서에 문의합니다.*

**해결 방법** 조직에서 메일 주소와 다른 ID를 사용하여 Microsoft 365 및 기타 Microsoft 서비스에 로그인합니다.  예를 들어 전자 메일 주소는 zalan.bola@contoso.com이지만 ID는 zalanb@contoso.com입니다.
...
**해결 방법** 몇 번 시도하는 경우도 있습니다. 암호를 여러 번 다시 시도했지만 여전히 로그인할 수 없는 경우 Incognito(Chrome) 또는 InPrivate(Edge) 모드에서 브라우저를 실행해 보세요.
