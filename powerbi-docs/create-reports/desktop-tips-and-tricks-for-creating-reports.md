...
필드를 올바르게 지오코딩하는 또 다른 방법은 데이터 필드에서 데이터 범주를 설정하는 것입니다. Power BI Desktop에서 원하는 테이블을 선택하고 고급 리본으로 이동한 다음, 데이터 범주를 주소, 도시, 대륙, 국가/지역, 국가, 우편 번호, 시/도로 설정합니다. 이러한 데이터 범주는 Bing에서 데이터를 올바르게 인코드하는 데 도움이 됩니다. 자세히 알아보려면 [Power BI Desktop의 데이터 분류](../transform-model/desktop-data-categorization.md)를 참조하세요.
...
### <a name="read-or-watch-how-to-design-visually-stunning-reports-and-dashboards"></a>"시각적으로 멋진 보고서(및 대시보드)를 설계하는 방법"을 읽거나 시청하세요.
...
* [웹 세미나를 시청하세요](https://community.powerbi.com/t5/Webinars-and-Video-Gallery/5-3-17-Webinar-How-to-Design-Visually-Stunning-Power-BI-Reports/m-p/168204?Is=Website)
