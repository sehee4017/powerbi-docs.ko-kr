...
> [!NOTE]
> [내 작업 영역](../collaborate-share/service-share-dashboards.md#share-a-dashboard-or-report) 내에서 개별적으로 공유된 **공유한 항목 보고서**는 교차 보고서 드릴스루와 함께 사용할 수 없습니다. 교차 보고서 드릴스루를 사용하려면 보고서가 공유된 작업 영역에서 보고서에 액세스해야 합니다.
