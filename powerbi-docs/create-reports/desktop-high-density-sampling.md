...
![고밀도 샘플링 데이터를 보여 주는 꺾은선형 차트의 스크린샷.](media/desktop-high-density-sampling/high-density-sampling_01.png)
...
![서식 창, 일반 및 고밀도 샘플링의 포인터를 보여 주는 고밀도 선 샘플링의 스크린샷.](media/desktop-high-density-sampling/high-density-sampling_02.png)
