...
![Power BI Desktop 보고서에서 눈금선 및 눈금에 맞춤을 사용하는 방법을 보여 주는 보고서 캔버스의 스크린샷.](media/desktop-gridlines-snap-to-grid/snap-to-grid_0.png)
...
![Power BI Desktop 보고서에서 눈금선 및 눈금에 맞춤을 사용하도록 설정하는 방법을 보여 주는 보고서 캔버스의 스크린샷.](media/desktop-gridlines-snap-to-grid/snap-to-grid_1.png)
...
![눈금선을 사용하여 시각적 개체를 정렬하는 방법을 보여 주는 보고서 캔버스의 스크린샷.](media/desktop-gridlines-snap-to-grid/snap-to-grid_2.png)
...
![Y축 카드의 눈금선 섹션을 보여 주는 시각적 개체의 스크린샷.](media/desktop-gridlines-snap-to-grid/snap-to-grid_9.png)
...
![눈금선 및 눈금에 맞춤을 통해 보고서의 시각적 개체가 깔끔하게 정렬되도록 하는 방법을 보여 주는 보고서 캔버스의 스크린샷.](media/desktop-gridlines-snap-to-grid/snap-to-grid_3.png)
...
![보고서에서 시각적 개체의 전후 순서를 관리하는 방법을 보여 주는 보고서 캔버스의 스크린샷.](media/desktop-gridlines-snap-to-grid/snap-to-grid_4.png)

**서식** 리본을 사용하면 여러 가지 다양한 방식으로 시각적 개체를 정렬할 수 있으므로 시각적 요소가 페이지에서 가장 잘 보이고 작동하는 맞춤 모양으로 표시됩니다.

![여러 가지 방법으로 시각적 개체를 정렬하는 방법을 보여 주는 보고서 캔버스의 스크린샷.](media/desktop-gridlines-snap-to-grid/snap-to-grid_5.png)

**맞춤** 단추를 사용하여 다음 이미지와 같이 선택한 시각적 개체를 보고서 캔버스의 가장자리(또는 가운데)에 맞춥니다.

![맞춤 단추를 사용하여 선택한 시각적 개체를 캔버스의 가장자리(또는 가운데)에 맞추는 방법을 보여 주는 보고서 캔버스의 스크린샷.](media/desktop-gridlines-snap-to-grid/snap-to-grid_6.png)
...
![왼쪽 맞춤 옵션을 사용하여 두 시각적 개체를 정렬하는 방법을 보여 주는 보고서 캔버스의 스크린샷.](media/desktop-gridlines-snap-to-grid/snap-to-grid_7.png)

또한 보고서 캔버스 전체에서 시각적 개체를 수직 또는 수평으로 균등하게 맞출 수 있습니다. **서식** 리본에서 **균등 맞춤** 단추를 사용만 하면 됩니다.

![균등 맞춤 옵션을 사용하여 캔버스에서 시각적 개체를 균등하게 분산하는 방법을 보여 주는 보고서 캔버스의 스크린샷.](media/desktop-gridlines-snap-to-grid/snap-to-grid_8.png)
