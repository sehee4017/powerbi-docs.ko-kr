...
| Azure Data Lake Store |예 |예 |예 |
| Azure HDInsight(HDFS) |예 |예 |예 |
| Azure HDInsight(Spark) |예 |예 |아니요 |
| Azure Table Storage |예 |예 |예 |
| Dynamics 365(온라인) |예 |예 |예 |
| Facebook |예 |예 |예 |
| 폴더 |예 |예 |아니요 |
| Google 웹로그 분석 |예 |예 |아니요 |
| HDFS(Hadoop 파일) |예 |예 |예 |
| IBM DB2 데이터베이스 |예 |예 |예 |
| Impala |예 |예 |예 |
| JSON |예 |예 |아니요 |
| Microsoft Exchange |예 |예 |아니요 |
| Microsoft Exchange Online |예 |예 |예 |
| MySQL 데이터베이스 |예 |예 |예 |
| OData 피드 |예 |예 |아니요 |
| ODBC |예 |예 |예 |
| OLE DB |예 |예 |예 |
...
| Azure Cosmos DB(베타) |예 |예 |예 |
| Azure HDInsight Spark(베타) |예 |예 |예 |
| Common Data Service(베타) |예 |예 |예 |
| comScore Digital Analytix(베타) |예 |예 |예 |
| Dynamics 365 for Customer Insights(베타) |예 |예 |예 |
| Dynamics 365 Financial(베타) |예 |예 |예 |
| GitHub(베타) |예 |예 |예 |
| Google BigQuery(베타) |예 |예 |예 |
| IBM Informix 데이터베이스(베타) |예 |예 |예 |
| IBM Netezza(베타) |예 |예 |예 |
| Kusto(베타) |예 |예 |예 |
| MailChimp(베타) |예 |예 |예 |
| Microsoft Azure Consumption Insights(베타) |예 |예 |예 |
| Mixpanel(베타) |예 |예 |예 |
| Planview Enterprise(베타) |예 |예 |예 |
| Projectplace(베타) |예 |예 |예 |
...
| tyGraph(베타) |예 |예 |예 |
| Vertica(베타) |예 |예 |예 |
| Visual Studio Team Services(베타) |예 |예 |예 |
| Webtrends(베타) |예 |예 |예 |
| Zendesk(베타) |예 |예 |예 |
...
| Amazon Redshift |예 |예 |예 |아니요 |
| Azure Blob Storage |예 |예 |예 |예 |
| Azure Data Lake Store |예 |예 |예 |예 |
| Azure HDInsight(HDFS) |예 |예 |예 |예 |
| Azure HDInsight(Spark) |예 |예 |예 |아니요 |
| Azure Table Storage |예 |예 |예 |예 |
| Dynamics 365(온라인) |예 |예 |예 |예 |
| Facebook |예 |예 |예 |예 |
| 폴더 |예 |예 |예 |예 |
| Google 웹로그 분석 |예 |예 |예 |아니요 |
| HDFS(Hadoop 파일) |예 |예 |예 |예 |
| IBM DB2 데이터베이스 |예 |예 |예 |예 |
| Impala |예 |예 |예 |아니요 |
| Microsoft Exchange |예 |예 |예 |아니요 |
| Microsoft Exchange Online |예 |예 |예 |예 |
...
| Power BI 서비스 |예 |예 |예 |예 |
| R 스크립트 |예 |예 |예 |아니요 |
| Salesforce 개체 |예 |예 |예 |아니요 |
| Salesforce 보고서 |예 |예 |예 |예 |
| SAP Business Warehouse 서버 |예 |예 |예 |예 |
| SAP HANA 데이터베이스 |예 |예 |예 |예 |
| SharePoint 폴더(온-프레미스) |예 |예 |예 |예 |
| SharePoint 목록(온-프레미스) |예 |예 |예 |예 |
| SharePoint Online 목록 |예 |예 |예 |아니요 |
| Snowflake |예 |예 |예 |예 |
| Sybase 데이터베이스 |예 |예 |예 |예 |
| Teradata |예 |예 |예 |예** |
| appFigures(베타) |예 |예 |예 |예 |
| Azure Analysis Services 데이터베이스(베타) |예 |예 |예 |예 |
| Azure Cosmos DB(베타) |예 |예 |예 |예 |
| Azure HDInsight Spark(베타) |예 |예 |예 |예 |
| Common Data Service(베타) |예 |예 |예 |예 |
| comScore Digital Analytix(베타) |예 |예 |예 |예 |
| Dynamics 365 for Customer Insights(베타) |예 |예 |예 |예 |
| Dynamics 365 Financial(베타) |예 |예 |예 |예 |
| GitHub(베타) |예 |예 |예 |예 |
| Google BigQuery(베타) |예 |예 |예 |예 |
| IBM Informix 데이터베이스(베타) |예 |예 |예 |예 |
| IBM Netezza(베타) |예 |예 |예 |예 |
| Kusto(베타) |예 |예 |예 |예 |
| MailChimp(베타) |예 |예 |예 |예 |
| Microsoft Azure Consumption Insights(베타) |예 |예 |예 |예 |
| Mixpanel(베타) |예 |예 |예 |예 |
| Planview Enterprise(베타) |예 |예 |예 |예 |
| Projectplace(베타) |예 |예 |예 |예 |
| QuickBooks Online(베타) |예 |예 |예 |아니요 |
| Smartsheet |예 |예 |예 |예 |
| Spark(베타) |예 |예 |예 |예 |
| SparkPost(베타) |예 |예 |예 |예 |
| SQL Sentry(베타) |예 |예 |예 |예 |
| Stripe(베타) |예 |예 |예 |예 |
| SweetIQ(베타) |예 |예 |예 |예 |
| Troux(베타) |예 |예 |예 |예 |
| Twilio(베타) |예 |예 |예 |예 |
| tyGraph(베타) |예 |예 |예 |예 |
| Vertica(베타) |예 |예 |예 |예 |
| Visual Studio Team Services(베타) |예 |예 |예 |예 |
| Webtrends(베타) |예 |예 |예 |예 |
| Zendesk(베타) |예 |예 |예 |예 |
...
| Azure SQL Data Warehouse |예 |예 |예 |예 |예 |
...
Power BI 서비스의 [Power BI 보고서에 대한 데이터 원본[(../connect-data/power-bi-data-sources.md) 이제 데이터 원본에 연결했으므로 해당 데이터 원본의 데이터를 사용하여 [Power BI 보고서를 만듭니다](quickstart-create-powerbi-report.md).
