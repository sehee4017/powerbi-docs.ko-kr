...
- [조직의 Power BI 라이선스 부여](service-admin-licensing-organization.md)
 ...
 - [개인으로 Power BI 가입](service-self-service-signup-for-power-bi.md)
