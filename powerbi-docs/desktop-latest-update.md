...
* \[동영상\]: 일부 기능에는 새 브라우저 탭의 기능을 설명하는 동영상 발췌가 있습니다.
* \[문서\]: 일부 기능에는 세부 정보를 제공하는 문서가 있습니다.
* 나머지 기능은 설명 없이도 바로 이해할 수 있으며 문서 또는 동영상이 필요하지 않습니다.

전체 [Power BI Desktop 월별 업데이트 동영상](#power-bi-desktop-monthly-update-video)도 시청할 수 있습니다.
...
## <a name="more-videos"></a>동영상 더 보기

동영상 및 기타 유용한 콘텐츠를 통한 Power BI 학습이 마음에 드시나요? 다음 동영상 원본과 콘텐츠 컬렉션을 확인합니다.

-   [Power BI 채널](https://www.youtube.com/user/mspowerbi): YouTube의 Power BI 동영상 컬렉션입니다.
